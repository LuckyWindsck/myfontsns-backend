...
export const shouldExist: ParamSchema = { exists: { errorMessage: 'Should exist' } };
export const shouldNotExist: ParamSchema = { exists: { negated: true, errorMessage: 'Should not exist' } };
export const shouldNotBeEmpty: ParamSchema = { notEmpty: { errorMessage: 'Should not be empty' } };
export const shouldBeEmail: ParamSchema = { isEmail: { errorMessage: 'Should an email' } };
